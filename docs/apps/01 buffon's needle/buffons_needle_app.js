...
export async function initPyodide() {
    ...
    const computationCode = await fetch('buffons_needle_computation.py').then(r => r.text());
    await pyodide.runPythonAsync(computationCode);
    
    // Load visualization module
    const visualizationCode = await fetch('buffons_needle_visualization.py').then(r => r.text());
