...
::: {.callout-tip}
## Beyond Basic Accept-Reject

**Markov Chain Monte Carlo (MCMC):** In higher dimensions, we need more sophisticated methods to sample from target distributions such as:
...
![Gilks, W. R., & Wild, P. (1992). Adaptive Rejection Sampling for Gibbs Sampling. Journal of the Royal Statistical Society. Series C (Applied Statistics), 41(2), 337–348. https://doi.org/10.2307/2347565](../images/adaptive.png)
