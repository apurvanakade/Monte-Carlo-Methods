...
## The Monte Carlo Estimation Strategy {#sec-monte-carlo-estimation-strategy}
...
In fact, we do not even need $\mathbb{E}[X] = \theta$. It suffices that $\lim_{n \to \infty} \hat{\theta} = \theta$ with high probability.
For details, see @sec-estimation-theory.
