...
This algorithm exploits the fact that Brownian motion has independent increments with $W_{t+\Delta t} - W_t \sim \mathcal{N}(0, \Delta t)$, making it a special case of the Euler-Maruyama method with $a(x,t) = 0$ and $b(x,t) = 1$.
